...
## Intallation
Just [download latest version](https://github.com/Romanitho/Winget-AutoUpdate/archive/refs/tags/v1.11.3.zip), unzip, run "install.bat" as admin to install by default.
