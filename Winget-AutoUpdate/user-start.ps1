<#
.SYNOPSIS
Run the task Winget-AutoUpdate manually from shortcut

.DESCRIPTION
If -Delta: Run in user context and get the delta between "system" apps and all apps (returned by user context command)
...
"@
    ...
    #Do the comparision in user context stuff here...
